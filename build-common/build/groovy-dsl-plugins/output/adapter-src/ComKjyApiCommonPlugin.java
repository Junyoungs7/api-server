...
/**
 * Precompiled com.kjy-api.common script plugin.
 **/
public class ComKjyApiCommonPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComKjyApiCommon").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.kjy-api.common.dependencies");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComKjyApiCommon").asSubclass(BasicScript.class);
