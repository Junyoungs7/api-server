...
/**
 * Precompiled com.kjy-api.common.dependencies script plugin.
 **/
public class ComKjyApiCommonDependenciesPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComKjyApiCommonDependencies").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComKjyApiCommonDependencies").asSubclass(BasicScript.class);
