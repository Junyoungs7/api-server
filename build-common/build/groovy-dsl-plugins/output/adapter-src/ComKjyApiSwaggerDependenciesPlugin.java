...
/**
 * Precompiled com.kjy-api.swagger.dependencies script plugin.
 **/
public class ComKjyApiSwaggerDependenciesPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComKjyApiSwaggerDependencies").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComKjyApiSwaggerDependencies").asSubclass(BasicScript.class);
